...
async function createTable() {
  ...
  await pool.execute('CREATE TABLE friends(userId varchar(100) NOT NULL, friendId varchar(100) NOT NULL, senderFirstName varchar(100) NOT NULL, senderSurname varchar(100) NOT NULL, receiverFirstName varchar(100) NOT NULL, receiverSurname varchar(100) NOT NULL, senderImage varchar(100), receiverImage varchar(100))');
  await pool.query(`insert into friends(userId,friendId,senderFirstName, senderSurname,) values('1','2')`);
